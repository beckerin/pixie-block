...
func TestPresentTxPrivacyRules(t *testing.T) {
	...
	tx := domain.PaymentTransaction{
		...
		Payer:     domain.Account{ID: "merchant_001", Type: domain.AccountTypeMerchant, Balance: 100, Currency: "BRL"},
		Payee:     domain.Account{ID: "person_001", Type: domain.AccountTypePerson, Balance: 50, Currency: "BRL"},
		Currency:  "BRL",
